...
## 이동된 자료
- `Studies/Phase 3/week9/` — TensorRT C++ 통합 (Jetson 활용 가정)
- `Studies/Phase 3/week10/` — Depth Anything V2 Jetson 정확도 검증
- `Studies/Phase 3/week11/` — Detection + Depth Jetson 융합
- `Studies/Phase 3/week12/` — 최종 데모 + Jetson 30+ FPS 목표
...
## 사용 시점
- 2027.07 산출물 #4 결정타 공개 후, 2027.11 분기 재평가 #3 에서 *Jetson 옵션 (#5) 진입 여부* 가 결정되면 본 자료 재참조
