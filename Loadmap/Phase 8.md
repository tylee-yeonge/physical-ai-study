...
## 📋 Section 8.1: 3D Detection 기초 (2주)
...
## 📋 Section 8.2: KITTI 3D Detection (4주)
...
- [ ] 2D Detection (Phase 7) 실무 경험
- [ ] 3D Detection (Phase 8) 프로젝트 경험
- [ ] Jetson 배포 경험
- [ ] 포트폴리오 3종 세트
