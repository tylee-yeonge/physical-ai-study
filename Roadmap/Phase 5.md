...
## Section 7.1: ViT — Vision Transformer (3주)
...
## Section 7.2: CLIP — Vision-Language Contrastive (3주)
...
## Section 7.3: DINOv2 — Self-Supervised Vision (3주)
...
## Section 7.4: SigLIP + Phase 4 demo 보강 (3주)
...
- **Phase 6: Isaac Sim + 디지털 트윈** (2027.05-07) — 자작 팔 Stage 2 와 병행
