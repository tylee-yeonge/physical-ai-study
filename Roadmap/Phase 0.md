# Phase 0: 역순 시작 - VINS-Fusion 먼저 돌려보기 [O] (1/2 ~ 1/3)
...
> [time] **기간**: 2주 → 실제 2일
> [goal] **목표**: 먼저 돌려보고, 모르는 것을 파악하여 학습 동기 확보
...
> [tip] 이미 ROS2 개발환경이 있다면 그대로 활용하세요
...
> [!] VINS-Fusion 원본은 **ROS1 기반**입니다. 아래 중 하나 선택:
...
> [tip] Phase 0에서는 **Option A (ROS1)**로 빠르게 돌려보는 것을 권장. ROS2 통합은 Phase 6에서 진행.
...
> [tip] evo는 궤적 평가의 표준 도구. ATE, RPE 등을 계산해줌.
...
> [tip] 이 단계에서 정확한 숫자는 중요하지 않음. "평가하는 방법을 안다"가 목표.
