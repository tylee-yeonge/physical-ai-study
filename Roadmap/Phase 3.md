...
> **공개 조건 2개**: (1) supporting 라벨 + README 계층 하위 배치 (v1 공개 전까지 perception 엔지니어로의 오독 방지), (2) 빌드 스크립트 기준 재현 확인 — TensorRT 엔진은 GPU 아키텍처 종속이고, 4070 은 보유 지속 (반납 취소, 2026-07-20 확정) 이나 휴직 중 장애 시 현장 방문 전까지 재빌드 불가라 물리 접근이 일상적인 8월 내가 안전한 마지막 창구다.
