...
- **Phase 4: VLA v1** (2026.06-09, 메인 단독) — pretrained OpenVLA zero-shot 추론 + ROS2 wrapper + sim 단일 task 루프 → **산출물 v1 (2026 하반기 레포 기록, 외부 공개는 v2 로 이관)**
- **하드웨어 스파이크 (2026.10, 2-3주)** — 2-DOF Dynamixel + ROS2 파이프라인 리스크 검증 (산출물 아님). 조달은 v1 과 병렬로 지금 착수.
- 병행: **시장 신호 probe** (JD 정독 + 커피챗 + LinkedIn 헤드라인, 2026.06~, 육아휴직 중 저강도)
- **6개월 분기 재평가 #1 (2026.11)** (스파이크 결과 / v1 결과 / probe 반응). **육아휴직(2026.06-2027.03) 중이라 정찰 지원은 안 하며, 본격 실지원은 복직(2027.03) 직후 개시.**
