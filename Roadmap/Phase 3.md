...
> **공개 조건 2개**: (1) supporting 라벨 + README 계층 하위 배치 (v1 공개 전까지 perception 엔지니어로의 오독 방지), (2) 빌드 스크립트 기준 재현 확인 — TensorRT 엔진은 GPU 아키텍처 종속이라 4070 반납 가능성 (2026.08 말 예정, 미확정) 을 고려하면 8월 내가 안전한 마지막 창구다.
