...
- **Phase 4: VLA v1** (2026.06-09, 메인 단독) — pretrained OpenVLA zero-shot 추론 + ROS2 wrapper + sim 단일 task 루프 → **산출물 v1 (첫 공개, 2026 하반기)**
...
- **정찰 지원 (2026.11-12)** + **6개월 분기 재평가 #1 (2026.11)** (스파이크 결과 / v1 반응 / probe 반응)
