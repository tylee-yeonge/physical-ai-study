...
- **Phase 4.5 (VLA v1.5)** — OpenVLA LoRA adaptation + before/after 정량 분석 (둘째 층 증거). Section 0 (sim 구축·Docker·RunPod 이관) 은 2026.08 전진 확정 (GPU 반납 대비), Sections 1-3 은 2026.09-11 ([Phase 4.5.md](Phase%204.5.md))
