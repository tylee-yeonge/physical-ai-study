...
## 📋 Section 1.1: 선형대수 기초 (3주) ✅ (1/4 ~ 1/14)

### Week 1: 3Blue1Brown으로 직관 얻기 ✅ (12월 중 완료, 로드맵 시작 전 선행)
...
## 📋 Section 1.2: 3D 기하학 (3주) ✅ (1/15 ~ 1/20)
...
### Week 6: Lie 군/대수 기초 ✅ (1/19 ~ 1/20)

> ⚠️ 처음에는 가볍게 훑고, VINS-Fusion 코드 (Phase 3)에서 필요할 때 돌아와서 심화
