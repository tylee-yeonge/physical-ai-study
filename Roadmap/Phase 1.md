# Phase 1: 수학 핵심 [O] (1/4 ~ 1/20)

> [time] **기간**: 2개월 → 실제 약 2.5주
> [goal] **목표**: SLAM에 필요한 수학만, 깊이보다 직관 우선
> [time] **주간 시간**: 약 7시간

---

## [list] Section 1.1: 선형대수 기초 (3주) [O] (1/4 ~ 1/14)

### Week 1: 3Blue1Brown으로 직관 얻기 [O] (12월 중 완료, 로드맵 시작 전 선행)
...
## [list] Section 1.2: 3D 기하학 (3주) [O] (1/15 ~ 1/20)
...
### Week 6: Lie 군/대수 기초 [O] (1/19 ~ 1/20)

> [!] 처음에는 가볍게 훑고, VINS-Fusion 코드 (Phase 3)에서 필요할 때 돌아와서 심화
...
## [list] Section 1.3: 최적화 기초 (2주) [O] (~1/20)
...
5. **Lie 군은 나중에**: Week 6은 가볍게 보고, Phase 3에서 필요할 때 돌아오기
