...
> **기간**: 2026.08-2027.06 (스파이크 2-3주 → Stage 1: 2개월 → Stage 2: 3개월)
...
- **산출물 #2.5**: 동작 영상 + URDF + Sim 임포트 영상 (1분, 2027.02까지)
...
| 2027.02 | Isaac Sim URDF 임포트 첫 사이클. 1분 영상 마감. | **산출물 #2.5** |
