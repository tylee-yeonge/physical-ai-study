...
> **하드웨어**: **Koch v1.1 리더-팔로워** (Dynamixel 기반, 2026-07 확정) + 카메라 (보유 ELP Stereo 활용). 기존 커스텀 6DOF 구성은 비채택 — BOM 절 참고
> **예산**: 약 46.7만원 (Koch v1.1 리더-팔로워, 2026.12 발주 — 리드타임 약 40일)
...
**비채택 기록**:
- 커스텀 XL330+XM430 풀세트 (BOM 약 150-225만원): Koch v1.1 확정으로 비채택 — 비용 약 4배 + 리더-팔로워 teleop 미지원 (별도 입력 장치 필요)
