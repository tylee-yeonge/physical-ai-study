...
> 스파이크·자작 팔의 현행 정본은 [Hardware-Arm.md](../../../Roadmap/Hardware-Arm.md) 스파이크 절과 하드웨어 확정 절이다. 아래 Step 의 문안은 실행 절차이며 정본을 대체하지 않는다.

**Files:**
- Modify: `Roadmap/Hardware-Arm.md` (가이드 안내 행, 보너스 절, 미확정 범위 주석)
...
- [x] **Step 3: 미확정 범위를 결정 기구별로 분리**

Hardware-Arm.md 의 미확정 주석을 결정 기구 기준으로 나눈다 — 스파이크 실행 시기는 **8월 초 체크포인트**(`Studies/Phase 4/notes.md` 진행 보드), Stage 2 확장 수단은 **2026.11 분기 재평가**. 확정 전 부품 발주는 보류한다. 현행 문안은 [Hardware-Arm.md](../../../Roadmap/Hardware-Arm.md) 스파이크 절·Stage 2 절이 정본이다.
...
- [x] **Step 2: 정식 체크포인트 안건 등재**

notes.md 의 8-12월 예산·배치 노트에 "정식 8월 초 체크포인트 안건" bullet 을 둔다 — 안건 목록의 정본은 그 bullet 이고, 이 문서에 복제하지 않는다.

- [x] **Step 3: 진행 원칙 bullet 을 안건 bullet 참조로 정리**

notes.md 진행 원칙의 8월 초 체크포인트 bullet 이 개별 안건을 나열하지 않고 위 안건 bullet 을 참조하게 한다. Phase 4.md 의 같은 bullet 도 동일하게 맞춘다 (Step 4-3 과 동일 사유).
