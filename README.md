...
6. **AMR 실무 경험이 차별점, Foundation Model 통합이 본체**: 7년 SW 경력 (자동차 R&D 보조 + 펌웨어 + AMR ROS) + 자작 팔 통합이 최대 무기
...
- 5년차 로봇 실무 경험은 대체 불가능한 자산. Perception을 논문으로만 아는 사람은 많지만, 실제 로봇 제품에 배포해본 사람은 드묾
