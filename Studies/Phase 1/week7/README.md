...
| 2 | Python 기초 실습 | `least_squares_basics.py` | 정규방정식, 직선 피팅 실습 |
| 3 | Python 심화 퀴즈 | `least_squares_quiz.py` | SVD, 위치 추정 퀴즈 |
