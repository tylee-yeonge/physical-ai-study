...
| 2 | Python 기초 실습 | `svd_basics.py` | SVD 기본 개념 및 기하학적 의미 실습 |
| 3 | Python 심화 퀴즈 | `svd_quiz.py` | 주관식 퀴즈 (문제/답안 분리) |
...
| 조건수 범위 | 분류 | 대처 방법 |
|------------|------|----------|
| **κ ≈ 1** | 완벽한 조건 (직교 행렬) | 문제 없음 [O] |
| **κ < 100** | 안정 | 일반 알고리즘 사용 |
| **κ < 1,000** | 약간 불안정 | 정규화 고려 |
| **κ < 10⁶** | 불안정 (ill-conditioned) | 정규화 필수 [!] |
| **κ > 10⁶** | 거의 특이 | 다른 방법 사용 [!] |
...
|---|---|---|
| **수치 안정성** | 조건수 제곱 (불안정) [!] | 안정적 [O] |
| **랭크 부족** | 역행렬 없음 [X] | 유사역행렬 사용 [O] |
