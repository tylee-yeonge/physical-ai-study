...
1. [O] SE(3) 변환 행렬의 구조를 이해하고 생성할 수 있다
2. [O] 동차 좌표(Homogeneous Coordinates)의 장점을 설명할 수 있다
3. [O] SE(3) 역변환 공식을 유도하고 계산할 수 있다
4. [O] 좌표계 변환과 상대 포즈를 이해할 수 있다
5. [O] ROS TF2와 변환 행렬의 관계를 이해할 수 있다
...
| 2 | Python 기초 실습 | `se3_basics.py` | SE(3) 변환 행렬 생성 및 연산 실습 |
| 3 | Python 심화 퀴즈 | `se3_quiz.py` | 주관식 퀴즈 (문제/답안 분리) |
