...
def problem1_solution():
    print("\n" + "=" * 50)
    print("문제 1 정답: B) 체크포인트 저장 시 이미 머지된다")
    print("=" * 50 + "\n")
    print("해설:")
    print("  학습 스크립트는 체크포인트를 저장할 때 LoRA 어댑터를 base 에 머지해")
    print("  통합 가중치로 저장한다. 손으로 머지할 일이 없다.")
    print()
    print("  그래서 이번 주 범위는 '전송 + 양자화 + 검증' 이다.")
    print("  단 어댑터 원본도 함께 회수한다 -- 용량이 작고, rank 를 바꿔 비교하거나")
    print("  머지를 다시 하고 싶을 때 필요하다.")
