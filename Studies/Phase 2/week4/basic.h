...
public:
     ...
     * @return 매칭 시간 (ms)
     */
    static double matchBruteForce(const cv::Mat& descriptors1,
     ...
     * @return 매칭 시간 (ms)
     */
    static double matchFLANN(const cv::Mat& descriptors1,
                            const cv::Mat& descriptors2,
                            std::vector<cv::DMatch>& matches);
     ...
     * @return 필터링 후 매칭 개수
     */
    static int ratioTest(const cv::Mat& descriptors1,
                        const cv::Mat& descriptors2,
     ...
     * @param output 출력 이미지
     */
    static void visualizeMatches(const cv::Mat& img1,
