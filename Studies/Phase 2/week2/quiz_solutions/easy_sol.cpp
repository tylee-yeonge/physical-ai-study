/**
 * Phase 2 Week 2 - 카메라 캘리브레이션 기초 퀴즈 (정답)
 *
 * 다루는 개념:
 ...
 * 정밀하게 측정하는 과정이다. Perception 파이프라인의 정확도는 캘리브레이션 품질에 직결된다.
 *
 * 왜곡 모델 (Brown-Conrady):
...
//   정밀한 Perception 시스템에서는 반드시 캘리브레이션된 K 사용
//
...
//   0.5 ≤ RMS < 1.0 : 양호 (GOOD) — 일반적 Perception 시스템에 적합
...
void problem3_rms_evaluation()
{
    ...
    std::cout << "   - 시나리오 B (RMS=0.85): GOOD → 일반적인 Perception 파이프라인에 적합" << std::endl;
...
//
// ★ 체커보드의 실제 크기가 중요: Stereo Depth 에서 절대 스케일을 결정
...
{
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" << std::endl;
    std::cout << "Phase 2 Week 2 Quiz - Easy (정답)" << std::endl;
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" << std::endl;
