...
Phase 5는 **딥러닝 기반 2D Perception**을 다루는 단계입니다. YOLO 객체 검출과 Depth Estimation을 배우기 전에, 그 기반이 되는 **PyTorch**를 확실히 잡아야 합니다.
...
print(f"총 메모리: {torch.cuda.get_device_properties(0).total_mem / 1e9:.1f} GB")
