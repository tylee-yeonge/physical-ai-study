...
> **이번 주 목표**: ViT 의 patch embedding + self-attention 구조를 한 페이지로 설명할 수 있는 수준에 도달. 모든 vision Transformer 의 토대.
> **예상 시간**: 10시간 (논문 정독 5h + 시각화 3h + 노트 2h)
> **핵심 질문**: "이미지를 어떻게 token 으로 만드는가? Token 으로 만들면 무엇이 가능해지는가?"
...
- 이전: [Phase 4 - VLA 논문 + ROS2 demo](../../../Roadmap/Phase%204.md)
