...
> [goal] **이번 주 목표**: CLIP 의 architecture 와 contrastive learning 의 원리를 한 페이지로 설명할 수 있다.
> [time] **예상 시간**: 8시간
> [tip] **핵심 질문**: "Image 와 text 를 같은 vector space 에 매핑하는 게 무슨 의미인가? 그게 'open-vocabulary' 인 이유는?"
...
[O] 이전: [Week 3](../week3/README.md) | 다음: [Week 5 - CLIP inference](../week5/README.md)
