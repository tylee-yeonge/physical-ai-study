...
> [goal] **이번 주 목표**: CLIP 으로 자작 팔 환경 객체를 open-vocabulary classification 하는 mini-demo. Phase 4 ROS2 demo 보강에 활용 가능.
> [time] **예상 시간**: 6시간
...
[O] 이전: [Week 5](../week5/README.md) | 다음: [Week 7 - DINOv2](../week7/README.md)
