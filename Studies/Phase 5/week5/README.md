...
> **이번 주 목표**: HuggingFace CLIP 으로 다양한 image-text pair 의 similarity 측정. zero-shot classification 시연.
> **예상 시간**: 6시간
> **핵심 질문**: "자작 팔 환경 image 에 대해 CLIP 의 zero-shot 정확도는?"
...
- 이전: [Week 4](../week4/README.md) | 다음: [Week 6](../week6/README.md)
