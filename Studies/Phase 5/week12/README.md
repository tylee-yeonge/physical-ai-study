...
> [goal] **이번 주 목표**: Phase 4 의 ROS2 demo 영상을 CLIP 시각화 / DINOv2 feature 등으로 보강 (선택). Phase 5 회고 + Phase 6 진입 직전 정리. **Phase 5 마지막 주**.
> [time] **예상 시간**: 5시간
