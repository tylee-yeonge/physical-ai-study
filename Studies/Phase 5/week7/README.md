...
> [goal] **이번 주 목표**: DINOv2 의 self-supervised learning (self-distillation, masked image modeling) 을 이해. OpenVLA 의 vision backbone 의 절반.
> [time] **예상 시간**: 8시간
> [tip] **핵심 질문**: "Text label 없이 어떻게 vision encoder 를 학습하는가? DINOv2 의 spatial 정보가 robot 에 왜 필요한가?"
...
[O] 이전: [Week 6](../week6/README.md) | 다음: [Week 8 - DINOv2 inference + viz](../week8/README.md)
