...
> **이번 주 목표**: ViT 의 이해 (week 1, 2) 와 OpenVLA 의 architecture (Phase 4 week 4) 를 연결. Phase 4 의 ROS2 demo latency 를 vision encoder 관점으로 재분석.
> **예상 시간**: 6시간
> **핵심 질문**: "OpenVLA 의 165 ms 중 vision (DINOv2 + SigLIP) 의 정확한 비중은?"
...
- 이전: [Week 2](../week2/README.md) | 다음: [Week 4 - CLIP 정독](../week4/README.md)
