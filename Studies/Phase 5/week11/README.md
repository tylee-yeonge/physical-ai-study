...
> [goal] **이번 주 목표**: Phase 5 의 4 모델 (ViT/CLIP/DINOv2/SigLIP) 통합. OpenVLA vision backbone 모든 component 설명 가능.
> [time] **예상 시간**: 6시간
...
[O] 이전: [Week 10](../week10/README.md) | 다음: [Week 12](../week12/README.md)
