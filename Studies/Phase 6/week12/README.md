...
> 🎯 **이번 주 목표**: Phase 6 전체를 정리한 블로그 포스팅을 작성하고, Demo 영상을 제작하며, LinkedIn을 통해 프로젝트를 공개한다.
> ⏰ **예상 시간**: 12-15시간
...
1. 제목 (눈길을 끄는 제목)
   ✗ "KITTI 3D Detection"
   ✓ "카메라 한 대로 3D 물체를 잡는다? — KITTI Monocular 3D Detection 도전기"
...
5. **Phase 6의 궁극적 목표**는 "KITTI와 nuScenes에서 3D Detection을 경험하고, 이를 GitHub + 블로그 + 영상으로 증명하여 이직을 준비하는 것"이다.
