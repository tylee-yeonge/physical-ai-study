...
> [goal] **이번 주 목표**: Isaac Sim 4.x 를 Ubuntu PC (RTX 4070) 에 설치하고 첫 hello-world Stage 동작.
> [time] **예상 시간**: 10시간
> [tip] **핵심 질문**: "Isaac Sim 이 RTX 4070 12GB 에서 정상 동작하는가? Python API 가 호출되는가?"
...
[O] 이전: [Phase 5](../../../Roadmap/Phase%205.md) | 다음: [Week 2](../week2/README.md)
