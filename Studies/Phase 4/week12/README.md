...
| 2 | C++ 퀴즈 (초급) | `quiz_easy.cpp` | 3단계 초기화 파이프라인과 V-I Alignment 기초 문제 |
| 3 | C++ 퀴즈 (중급) | `quiz_medium.cpp` | Visual-Inertial Alignment 선형 시스템 구성 및 풀이 |
| 4 | 실습 | [PRACTICE.md](./PRACTICE.md) | VIO 초기화 파이프라인 단계별 구현 실습 |
