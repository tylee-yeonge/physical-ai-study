...
> [goal] **실습 목표**: 빈 동작 (dummy) 의 vla_node 가 colcon build + ros2 run 으로 정상 동작.
> [time] **예상 시간**: 6~8시간
...
## [note] 실습 2: vla_inference_node.py 골격
...
## [note] 실습 5: image_publisher 로 dummy image 발행 (선택)
