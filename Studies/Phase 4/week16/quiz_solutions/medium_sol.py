...
def problem2_solution():
    ...
    print("=" * 60 + "\n")
    decisions = [
        ("A", "probe 반응 좋음, 신모델 X", 2, "실지원 + #4 가속"),
        ("B", "probe 반응 좋음, 신모델 등장", 4, "모델 갱신 + 실지원"),
        ("C", "probe 반응 약함, 신모델 X", 3, "fallback (2028.03) + Jetson"),
        ("D", "probe 반응 약함, 신모델 등장", 5, "모델 갱신 + fallback"),
    ]
    ...
    print()
    print("  'probe 반응 약함 + 신모델 X' 가 가장 위험:")
