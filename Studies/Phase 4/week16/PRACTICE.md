...
> [goal] **실습 목표**: Phase 4 의 모든 산출물 공개 + 회고 + Phase 5 진입 직전 정리.
> [time] **예상 시간**: 4시간

---

## [note] 실습 1: 최종 git push + tag
...
> [tip] Phase 5 의 깊이는 '동작 원리 수준' (아키텍처 다이어그램 + 학습 방식 + 입출력 인터페이스). 너무 깊이 들어가지 말 것.
