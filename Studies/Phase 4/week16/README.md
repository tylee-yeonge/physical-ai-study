...
> [goal] **이번 주 목표**: 산출물 #2 (Portfolio/02_VLA_demo/) 를 GitHub Public 으로 공개 + LinkedIn 공지. Phase 5 진입 직전 정리. **Phase 4 마지막 주**.
> [time] **예상 시간**: 4시간 (publishing 2h + LinkedIn / 회고 2h)
> [tip] **핵심 질문**: "내 산출물 #2 가 GitHub 검색 / LinkedIn 에 노출되는가? 면접관이 자연스럽게 발견할 수 있는가?"
...
본 주가 끝나면:
- [O] **산출물 #2 완료**: 블로그 2편 + ROS2 minimal demo + 1분 영상
- [O] **2026.12** 시점 본인이 가진 패: #1 (Detection+Depth+TRT+ROS2) + #2 (VLA) + #2.5 (자작 팔 Stage 1)
- [O] **2026.11~12 정찰 지원** 의 핵심 카드 준비
...
[O] 이전: [Week 15 - 영상 마감 + 자막](../week15/README.md)
