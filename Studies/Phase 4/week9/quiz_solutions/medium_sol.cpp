...
void problem1_solution()
{
    ...
    std::cout << "    회전: " << BQBt(0, 0) << " = dt·σ²_g = " << dt * sigma_gyro * sigma_gyro
              << std::endl;
    std::cout << "    속도: " << BQBt(3, 3) << " = dt·σ²_a = " << dt * sigma_acc * sigma_acc
              << std::endl;
...
void problem3_solution()
{
    ...
    std::cout << "  Factor A (0.1초): E = r²/σ² = " << r * r << "/" << s2_A << " = " << r * r / s2_A
              << std::endl;
    std::cout << "  Factor B (1.0초): E = r²/σ² = " << r * r << "/" << s2_B << " = " << r * r / s2_B
              << "\n"
              << std::endl;
