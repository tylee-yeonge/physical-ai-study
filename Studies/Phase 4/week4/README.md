...
> [goal] **이번 주 목표**: OpenVLA 논문을 1회독하고, Llama 7B + DINOv2 + SigLIP 라는 hybrid vision encoder 구조를 한 페이지로 설명할 수 있는 수준에 도달한다.
> [time] **예상 시간**: 10~12시간
> [tip] **핵심 질문**: "OpenVLA 가 RT-2 의 open-source 재현이라면, 그저 작은 모델을 쓴 것 외에 어떤 본질적 개선이 있는가?"
...
> [tip] week 5 에서 OpenX-Embodiment 의 자세한 구조와 fine-tuning 흐름을 다룬다.
...
[O] 이전: [Week 3 - RT-2 블로그 1편 작성](../week3/README.md)
