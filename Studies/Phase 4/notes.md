...
- **정식 8월 초 체크포인트 안건 (2026-07-20 등재, 입력: 7월 실가용 실적)**: (1) 조기 결론 재확인 (Section 0 2026.08 / Sections 1-3 2026.09-11), (2) 하드웨어 스파이크 실행 시기 결정 — 9월 절충안 vs 원안 10월 (8월은 GPU 종속 작업 과밀로 제외) + 부품 구성(2-DOF 커스텀 vs Koch v1.1 BOM 정합) 선결정, 확정 전 부품 발주 보류, (3) 순서 6 정독 잠정치 갱신, (4) git filter-repo 실행 여부 확정 — 레포 비공개 유지·산출물 repo 분리(2026-07-20)로 불요 예상, 산출물 repo 신원 설정 확인으로 대체 (진행 원칙 항목).
