...
> [goal] **실습 목표**: RTX 4070 12GB 에서 OpenVLA 4-bit inference 가 동작하고, 첫 latency 데이터를 확보한다.
> [time] **예상 시간**: 6~8시간
...
> [tip] 첫 실행 시 모델 다운로드에 ~ 15GB 디스크 사용 + ~ 5~10분 시간.

---

## [note] 실습 2: Latency 측정 (산출물 #4 의 기초 데이터)
...
> [tip] 이 latency 데이터를 Phase 7 의 산출물 #4 영상에서 직접 인용. "RTX 4070 + 4-bit OpenVLA = 6Hz, 5Hz robot control 가능".
