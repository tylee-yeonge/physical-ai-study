...
> [goal] **이번 주 목표**: OpenVLA 의 HuggingFace 모델 카드를 정독하고, RTX 4070 12GB 환경에서 4-bit quantization 으로 inference 실행까지 가져간다. (week 7 블로그 + week 8~ ROS2 demo 의 사전 준비)
> [time] **예상 시간**: 8~10시간
> [tip] **핵심 질문**: "OpenVLA inference 가 내 환경에서 동작하는가? 한 frame 의 latency 는 몇 ms 인가?"
...
> [tip] LM decoder 의 시간이 압도적. 이게 줄어들면 (speculative decoding 등) latency 전체가 좋아짐.
...
[O] 이전: [Week 5 - OpenX-Embodiment + Fine-tuning](../week5/README.md)
