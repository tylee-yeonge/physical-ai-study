# Week 3: RT-2 vla-lab 문서 1편 작성


> **[v1 범위 조정 — 2026-06]** 이 주차(RT-2 vla-lab 문서 작성)는 **v1 에서 제외하고 v2(Phase 6)로 이관**했다. v1 범위는 week1-2 의 RT-2 정독(아키텍처 이해)까지다. 정독 노트는 v2 vla-lab 문서의 배경으로 재사용한다. 아래 vla-lab 문서 작성 가이드는 v2 공개 단계 참조용으로 보존한다. 결정 배경: `Roadmap/Phase 4.md` "산출물 v1" 절.


> **이번 주 목표**: week 1-2 의 reading note 와 한 페이지 노트를 합쳐서 **공개 가능한 RT-2 vla-lab 문서 1편** 의 초고를 마감한다. 산출물 v1 의 절반 (vla-lab 문서 2편 중 1편).
> **예상 시간**: 10-12시간 (vla-lab 문서 본문 6h + 다이어그램 2h + 퇴고 2-4h)
> **핵심 질문**: "내 vla-lab 문서 글을 처음 보는 사람이 30분 안에 RT-2 의 본질과 한계를 이해할 수 있는가?"
...
| 순서 | 단계 | 파일/자료 | 설명 |
|:----:|------|----------|------|
| 1 | 발행 채널 확인 | `PRACTICE.md` 1 | vla-lab (공개 산출물 repo — 2026-08-30 확정) |
| 2 | 글 구조 잡기 | `PRACTICE.md` 2 | 표준 8-section 구조로 outline |
| 3 | 다이어그램 작성 | `PRACTICE.md` 3 | Mermaid 또는 손그림 사진 |
| 4 | 본문 작성 | vla-lab 문서 | 약 3000-4000 자 한국어 |
| 5 | 퀴즈 (vla-lab 문서 평가) | `quiz_easy.py` | "이 vla-lab 문서가 좋은 글인가" 자가 체크 |
...
## 시작하기 전에 — vla-lab 문서가 왜 산출물인가


본 로드맵에서 vla-lab 문서는 단순한 "공부 노트" 가 아니다. **면접관의 진입점** 이다.


| 면접관이 vla-lab 문서를 보는 이유 | 어떤 평가를 하는가 |
|---|---|
...
좋은 vla-lab 문서 1편 = 좋은 이력서 1줄과 같은 무게.


> 본 phase 의 산출물 v1 는 "vla-lab 문서 2편 + ROS2 demo" 다. vla-lab 문서 1편이 못 나오면 산출물 자체가 흔들린다. 이번 주가 본 phase 의 첫 결정타.
...
### 3. RT-2 vla-lab 문서의 8-section 권장 내용
...
- 양산 SW 엔지니어가 이 모델을 보면:
  ...
  - 양산 비용 (GPU VRAM / 메모리)
- Phase 7 산출물 v3 에서 이 한계들을 직접 측정할 예정
...
> 본 phase 권장: **Mermaid** 우선 (vla-lab 문서에 inline 가능). 복잡한 경우 Excalidraw.
...
| Reference 가 1-2개 | 최소 5개 (논문, vla-lab 문서, 코드, 강의) |


### 8. vla-lab 문서 SEO + 검색 가능성
...
## 본 로드맵의 vla-lab 문서 활용 전략


1. **vla-lab 문서 1편 = 산출물 v1 의 1/3** (총: vla-lab 문서 2편 + ROS2 demo)
2. **vla-lab 문서 2편이 모이면 LinkedIn 컨택 시 첫 명함**
3. **면접 시 "내 vla-lab 문서 봤어요?" 가 가장 좋은 첫 마디**
4. **vla-lab 발행 + LinkedIn 링크 공유** (2026-08-30 채널 확정 — velog/Medium 미사용)
5. **본 레포 `Studies/Phase 4/blog/rt2.md` 는 초고 작업 공간** (발행본은 vla-lab)


> vla-lab 에 같은 분야 글이 누적될수록 repo 자체가 포트폴리오로 읽힌다. 본 phase 끝에 문서 2편이 있으면 vla-lab 이 빈 repo 를 벗어난다.
...
**Q1. vla-lab 문서의 8-section 구조에서 가장 분량이 큰 section 은?**
> Section 4 (자세한 동작 / 수식 / 코드). 권장 1000자. 글의 깊이를 결정.


**Q2. 면접관이 vla-lab 문서를 보고 가장 빠르게 평가하는 부분은?**
> Section 1 (한 줄 요약) 과 Section 3 (한 페이지 요약). 30초 안에 글의 가치 판단.


**Q3. 좋은 vla-lab 문서와 나쁜 vla-lab 문서의 가장 큰 차이는?**
> "한계 / 비판" 의 유무. 좋은 vla-lab 문서는 모델의 단점을 정직하게 5가지 언급. 나쁜 vla-lab 문서는 장점만 나열.


**Q4. 본 로드맵의 vla-lab 문서 1편의 분량 권장 범위는?**
> 한국어 3000 ~ 4000 자. 너무 길면 다 안 읽힘, 너무 짧으면 깊이 부족.


**Q5. RT-2 vla-lab 문서에서 자기 차별화 메시지는 무엇에 쓸 수 있나?**
> Section 7 (본 로드맵 관점). "양산 SW 엔지니어로서 이 모델의 latency / quantization 의 의미" 같은 본인 강점이 드러나는 해석. 박사/연구자 vla-lab 문서와 가장 큰 차이.
...
### 이번 주 실습 과제
1. 발행 채널 확인 (vla-lab — 2026-08-30 확정)
...
- RT-2 vla-lab 문서 발행 직후의 피드백 모니터링 (LinkedIn / Twitter 등)
...
1. **vla-lab 문서는 면접관의 진입점**: 단순 노트가 아닌 산출물.
