...
> outline 을 본문 작성 전에 먼저 마감하면 작성 시간이 절반으로 줄어든다.
...
> 본문에는 다이어그램 1 (Architecture) 은 필수, 2-3 은 선택.


---


## 실습 4: 본문 작성 가이드 (Section 4 의 예시)
...
> 본 예시처럼 "수치 → 의미 → 한계" 순서로 작성하면 자연스럽게 깊이가 드러난다.
