...
| 2 | C++ 퀴즈 (초급) | `quiz_easy.cpp` | Kalibr 캘리브레이션 절차와 결과 해석 기초 문제 |
| 3 | C++ 퀴즈 (중급) | `quiz_medium.cpp` | 캘리브레이션 결과 검증 및 VINS config 적용 |
| 4 | 실습 | [PRACTICE.md](./PRACTICE.md) | Kalibr 캘리브레이션 실행 및 결과 검증 실습 |

---

## 🌟 시작하기 전에

> **⚠️ 사전 준비: Jetson Orin Nano + ELP 스테레오 카메라 + IMU 필요**
> 이번 주는 실제 하드웨어로 캘리브레이션을 수행합니다.
> Phase 2 Week 2의 **스테레오 캘리브레이션**을 아직 하지 않았다면, 이번 주 시작 전에 먼저 완료하세요.
