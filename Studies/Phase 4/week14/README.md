...
> [goal] **이번 주 목표**: `Portfolio/02_VLA_demo/README.md` 를 면접관이 따라할 수 있는 수준으로 다듬는다. 다른 사람도 환경 셋업 + 재현 가능.
> [time] **예상 시간**: 6시간 (README 작성 4h + 검증 2h)
> [tip] **핵심 질문**: "내 README 만 따라가서 다른 사람이 30분 안에 inference 동작까지 갈 수 있는가?"
...
[O] 이전: [Week 13 - 블로그 퇴고](../week13/README.md)
