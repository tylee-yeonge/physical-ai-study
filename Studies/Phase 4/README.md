...
**왜 별도 단계가 필요한가**: OpenVLA 7B 는 RTX 4070 12GB 로 학습이 불가능하다. 학습은 RunPod (Community Cloud RTX 4090), 추론은 로컬 4070 + 4bit 양자화로 분업하는 것이 본 Phase 의 핵심 의사결정이다 (노트북형 클라우드는 SSH 불가·세션 휘발로 배제, 2026-07). 환경을 두 갈래로 구축해야 하므로 week 1 진입 전에 미리 짚어둔다. 컴퓨트 전략의 근거, 버전 매칭, 가중치 전송 워크플로우, 주차별 환경 요구도가 모두 SETUP.md 에 정리되어 있다.

**진행 순서 변형 (2026.06-07 선행 투입)**: 실행 순서는 표적 skim → week8-12 실습 선행이고, week1-7 정독/vla-lab 문서는 2026.08-09 후행이다. week 디렉토리 구조와 자료는 원안 그대로다. 상세: [`Roadmap/Phase 4.md`](../../Roadmap/Phase%204.md)의 "진행 순서 변형" 섹션.
...
```
Studies/Phase 4/
  week1/ ~ week3/ # RT-2 정독 + vla-lab 문서 1편
  week4/ ~ week7/ # OpenVLA 정독 + vla-lab 문서 1편
  week8/ ~ week12/ # OpenVLA HuggingFace → ROS2 minimal demo
  week13/ ~ week16/ # vla-lab 문서 마무리 + 산출물 v1 패키징
  blog/ # RT-2 / OpenVLA vla-lab 문서 초고
