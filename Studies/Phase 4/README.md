...
**진행 순서 변형 (2026.06-07 선행 투입)**: 실행 순서는 표적 skim → week8-12 실습 선행이고, week1-7 정독/블로그는 2026.08-09 후행이다. week 디렉토리 구조와 자료는 원안 그대로다. 상세: [`Roadmap/Phase 4.md`](../../Roadmap/Phase%204.md)의 "진행 순서 변형" 섹션.
