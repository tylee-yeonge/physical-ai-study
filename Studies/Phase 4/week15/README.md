...
> **[v1 범위 조정 — 2026-06]** 이 주차(1분 영상 최종 마감)는 **v1 에서 제외하고 v2(Phase 6)로 이관**했다. v1 은 1분 영상을 만들지 않으므로 마감 대상도 없다. 아래 자막/thumbnail/export 가이드는 v2 영상 제작 시 참조용으로 보존한다. 결정 배경: `Roadmap/Phase 4.md` "산출물 v1" 절.
