...
> [goal] **이번 주 목표**: week 12 의 영상을 최종 마감. 자막 / 음악 / 인트로 / 아웃트로 / thumbnail. 면접관 진입점으로 완성.
> [time] **예상 시간**: 6시간
> [tip] **핵심 질문**: "내 영상이 다른 후보 영상과 비교해 면접관이 가장 오래 머무는가?"
...
[O] 이전: [Week 14 - README + 환경 가이드](../week14/README.md)
