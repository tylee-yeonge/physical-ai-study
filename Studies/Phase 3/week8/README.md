...
> [goal] **이번 주 목표**: Depth Anything 모델로 실제 이미지의 깊이맵을 추론하고 시각화하기
> [time] **예상 시간**: 12시간
> [tip] **핵심 질문**: "Depth Anything으로 추정한 깊이맵을 실제로 어떻게 활용할 수 있을까?"
