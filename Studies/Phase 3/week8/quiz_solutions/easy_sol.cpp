/**
 * Quiz Easy (정답) - Week 8: Ceres Bundle Adjustment
 *
 * 이 퀴즈에서 다루는 개념:
...
void problem2_autodiff_template()
{
    ...
    // ✅ 정답:
    std::cout << "   답: 잔차 차원(2), 카메라 파라미터 블록(6), 3D 점 블록(3)\n" << std::endl;
}
...
void problem6_set_constant()
{
    ...
    std::cout << "   d) 정확도 향상\n";
    // ✅ 정답:
    std::cout << "   답: c) Gauge freedom 제거\n" << std::endl;
}

int main()
{
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" << std::endl;
    std::cout << "Week 8 Quiz - Easy (정답)" << std::endl;
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" << std::endl;
