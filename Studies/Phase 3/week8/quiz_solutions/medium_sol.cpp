/**
 * Quiz Medium - Week 8: Ceres Bundle Adjustment (정답)
 *
 * 이 퀴즈에서 다루는 개념:
...
void problem1_jet_type()
{
    ...
    // ✅ 정답: 함수값(a)과 N개의 편미분 값(v)을 동시에 저장
    std::cout << "   설명: 함수값(a)과 N개의 편미분 값(v)을 동시에 저장\n";
    std::cout << "   → 순방향 패스 한 번으로 함수값 + 모든 Jacobian 계산\n" << std::endl;
}
...
void problem2_dense_schur()
{
    ...
    // ✅ 정답: Hll이 블록 대각 → 3D 점 소거 후 포즈만의 밀집 시스템
    std::cout << "   답: Hll이 블록 대각 → 3D 점 Schur 소거 후\n";
    std::cout << "   포즈만의 밀집(dense) reduced system을 밀집 솔버로 풀이\n" << std::endl;
}
...
void problem3_ceres_vs_g2o()
{
    ...
    // ✅ 정답:
    std::cout << "   Ceres 권장: AutoDiff로 빠른 프로토타이핑, VIO/센서 융합\n";
    std::cout << "   g2o 권장: SLAM 특화 타입(SE3/Sim3), ORB-SLAM 생태계 통합\n" << std::endl;
}

int main()
{
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" << std::endl;
    std::cout << "Week 8 Quiz - Medium (정답)" << std::endl;
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" << std::endl;
