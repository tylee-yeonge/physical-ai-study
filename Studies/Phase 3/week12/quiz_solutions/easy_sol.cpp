/**
 * Quiz Easy (정답) - Week 12: Monocular 스케일 모호성
 *
 * 이 퀴즈에서 다루는 개념:
...
void problem1_why_no_scale()
{
    ...
    // ✅ 정답:
    std::cout << "  답: b) 3D 점 X와 λX가 같은 2D 픽셀에 투영되기 때문\n" << std::endl;
...
void problem2_t_normalization()
{
    ...
    // ✅ 정답:
    std::cout << "  답: b) t의 크기가 결정 불가하므로 방향만 사용하기 위해\n" << std::endl;
...
void problem3_scale_drift()
{
    ...
    // ✅ 정답:
    std::cout << "  답: b) 매 프레임 스케일 오차가 누적되어 맵이 왜곡되는 현상\n" << std::endl;
...
void problem4_when_scale_known()
{
    ...
    // ✅ 정답:
    std::cout << "  답: b) 스테레오 카메라 (baseline 알려짐)\n" << std::endl;
...
{
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" << std::endl;
    std::cout << "Week 12 Quiz - Easy (정답)" << std::endl;
