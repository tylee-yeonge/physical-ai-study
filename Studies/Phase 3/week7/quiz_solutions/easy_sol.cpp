/**
 * Quiz Easy (정답) - Week 7: Bundle Adjustment (g2o)
 *
 * 이 퀴즈에서 다루는 개념:
...
void problem1_ba_minimize()
{
    ...
    std::cout << "   d) 시간 지연\n";
    // ✅ 정답: b) 재투영 오차
    std::cout << "   정답: b) 재투영 오차" << std::endl;
    std::cout << "   BA는 Σ ||observed - projected||² 를 최소화" << std::endl;
}
...
void problem2_vertex()
{
    ...
    std::cout << "   d) 오차 함수\n";
    // ✅ 정답: a) 최적화 변수
    std::cout << "   정답: a) 최적화 변수" << std::endl;
    std::cout << "   Vertex = 카메라 포즈, 3D 점 등 최적화할 변수" << std::endl;
}
...
void problem3_edge()
{
    ...
    std::cout << "   d) 3D 점\n";
    // ✅ 정답: b) 제약 조건
    std::cout << "   정답: b) 제약 조건" << std::endl;
    std::cout << "   Edge = 재투영 제약 등 오차 함수" << std::endl;
}
...
void problem4_huber_loss()
{
    ...
    std::cout << "   d) 정확도 향상\n";
    // ✅ 정답: b) Outlier 영향 감소
    std::cout << "   정답: b) Outlier 영향 감소" << std::endl;
    std::cout << "   큰 오차를 선형화하여 outlier 영향 제한" << std::endl;
}
...
void problem5_schur()
{
    ...
    // ✅ 정답: b) 속도 향상
    std::cout << "   정답: b) 속도 향상" << std::endl;
    std::cout << "   카메라만 먼저 최적화 → 차원 감소 → 10-100배 빠름" << std::endl;
}

int main()
{
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" << std::endl;
    std::cout << "Week 7 Quiz (Easy) (정답)" << std::endl;
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" << std::endl;
