...
> **학습 기간**: ~2026.06 초 (week1-7 완료, week8 통합 노드 마무리)
> **상태**: **비공개 리허설** — 공개 산출물 아님. Detection+Depth+PC TensorRT/ROS2 통합은 VLA v1 wrapper 의 재사용 스캐폴드다.
...
- 정책(비공개 리허설), 주차별 상세 학습 내용은 모두 [`Roadmap/Phase 3.md`](../../Roadmap/Phase%203.md) 에 있음. 본 디렉토리는 학습 노트 모음.
- Jetson 실기 배포 자료는 [`Archive/Phase3-jetson-legacy/`](../../Archive/Phase3-jetson-legacy/) 에 있음. Jetson 배포는 v3 이후 옵션.
