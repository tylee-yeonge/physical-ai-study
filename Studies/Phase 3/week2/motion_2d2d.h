...
class Motion2D2D
{
   public:
     ...
     */
    static int recoverPose(const cv::Mat& E, const std::vector<cv::Point2f>& points1,
     ...
     */
    static void normalizePoints(const cv::Mat& K, const std::vector<cv::Point2f>& points,
     ...
     */
    static void triangulate(const cv::Mat& K, const cv::Mat& R, const cv::Mat& t,
     ...
     * @return 성공 여부
     */
    static bool pipeline(const cv::Mat& K, const std::vector<cv::Point2f>& points1,
                         const std::vector<cv::Point2f>& points2, cv::Mat& R, cv::Mat& t,
                         std::vector<cv::Point3f>& points3d);
