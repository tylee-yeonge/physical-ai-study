...
void problem2_trtexec_command()
{
    ...
    std::cout << std::endl;
    std::cout << "  a) --saveEngine=yolo11n.trt --int8" << std::endl;
    std::cout << "  b) --saveEngine=yolo11n_fp16.trt --fp16" << std::endl;
    std::cout << "  c) --saveEngine=yolo11n.engine --half" << std::endl;
    std::cout << "  d) --saveEngine=yolo11n_fp16.trt --float16" << std::endl;
    std::cout << std::endl;
