/**
 * Quiz Easy (정답) - Week 13: 스케일 복구 방법
 *
 * 이 퀴즈에서 다루는 개념:
...
void problem1_stereo_depth()
{
    ...
    // ✅ 정답:
    std::cout << "   답: b) depth = f * b / disparity\n" << std::endl;
...
void problem2_vision_imu_complementary()
{
    ...
    // ✅ 정답:
    std::cout << "   답: b) Vision은 방향이 정확하지만 스케일이 모호하고,\n";
    std::cout << "      IMU는 스케일 정보를 제공하지만 드리프트가 있다\n" << std::endl;
...
void problem3_gps_indoor()
{
    ...
    // ✅ 정답:
    std::cout << "   답: c) 실내에서는 GPS 위성 신호를 수신할 수 없기 때문\n" << std::endl;
...
void problem4_vio_definition()
{
    ...
    // ✅ 정답:
    std::cout << "   답: b) Visual-Inertial Odometry - 카메라와 IMU를 융합한 주행 거리 측정\n" << std::endl;
...
{
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" << std::endl;
    std::cout << "Week 13 Quiz - Easy (정답)" << std::endl;
